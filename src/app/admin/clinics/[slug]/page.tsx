...
export default function ClinicEditor() {
  ...
  const [keys, setKeys] = useState<(keyof Clinic)[]>([])
  ...
  useEffect(() => {
    ...
    fetch(`/directory/api/admin/clinics/${params.slug}`)
      .then(res => res.json())
      .then(setClinic)
  ...
  setKeys(Object.keys(clinic) as (keyof Clinic)[])
}, [clinic])
  ...
  const handleSubmit = async () => {
    const url = isNew ? '/api/admin/clinics' : `/api/admin/clinics/${params.slug}`

...
import type { SearchFilters, Practitioner, Clinic } from "@/lib/types"
...
export default function HomePage({clinics,practitioners}:{clinics:Clinic[],practitioners:Practitioner[]}) {

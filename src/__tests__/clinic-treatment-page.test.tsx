...
const logFile = fs.createWriteStream('clinic-treatment-collections.log', { flags: 'w' });
...
describe('PractTreatmentPage rendering', () => {
  ...
  test('all city/service combinations render without crashing', () => {
      modalities.forEach((treatmentslug) => {
        ...
        try {
          //console.log(`Testing Page: /directory/practitioners/${cityslug}/treatments/${treatmentslug}`);
          ...
          console.log(`/directory/practitioners/${cityslug}/treatments/${treatmentslug}: ${ClinicsList.length} cards found.`);
          unmount();

        } catch (e) { 
          console.log(`No cards found at /directory/practitioners/${cityslug}/treatments/${treatmentslug}`);
        } 
      }); 
    });
  });
...
describe('ClinicTreatmentPage rendering', () => {
  ...
  test('all city/service combinations render without crashing', () => {
      modalities.forEach((serviceslug) => {
        try {
          //console.log(`Testing Page: /directory/clinics/${cityslug}/services/${serviceslug}`);
          const { unmount } = render(
            <TestServicesCount
          ...
          const ClinicsList = screen.getAllByTestId('practitioner-card');  
          console.log(`/directory/clinics/${cityslug}/services/${serviceslug}: ${ClinicsList.length} cards found.`);
          unmount();

        } catch (e) { 
          console.log(`Error at /directory/clinics/${cityslug}/services/${serviceslug}`);
        } 
      });
    });   
  });
...
//   locations.forEach((cityslug) => {
//   test('all city/clinic combinations render without crashing', () => {
//       clinics.forEach((clinic) => {
//         const slug=clinic.slug!
//         try {
//           //console.log(`Testing Page: /directory/clinics/${cityslug}/clinic/${slug}`);
//           const { unmount } = render(
//             <TestClinicsCount
...
//         } catch (e) { 
//           console.log(`Error at /directory/clinics/${cityslug}/clinic/${slug}`);
//         } 
//       });
//     });   
//   });
...
//   });
  ...
  //       console.log(`/directory/clinics/${clinic.slug}`);
  //       cleanup();
  //     } catch (error) {
  //       renderErrors.push({ 
  //         slug: clinic.slug, 

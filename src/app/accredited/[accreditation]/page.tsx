...
export default async function AccreditationPage({ params }: Readonly<AccreditationPageProps>) {
...
export async function generateMetadata({ params }: AccreditationPageProps) {
  const { accreditation } = params
  const accreditationName = getAccreditationName(accreditation)
